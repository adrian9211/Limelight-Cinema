...
if(isset($_SESSION['logged-in'])) {
    ...
    {
        $updateQuerry = "UPDATE users SET Username = '$_POST[Username]', Password = '$_POST[Password]' ,FirstName = '$_POST[FirstName]', Surname = '$_POST[Surname]', DOB = '$_POST[dob]', Privileges = '$_POST[Privileges]' WHERE UserID = '$_POST[hidden]'";
...
//            echo 'User deleted';
    ...
    {
        $insertQuerry = "INSERT INTO users (Username, Password, FirstName, Surname,  DOB) VALUES ('$_POST[Username]', '$_POST[Password]','$_POST[FirstName]', '$_POST[Surname]', '$_POST[dob]')";
...
//            echo "New User record inserted";
    ...
    {
        $updateQuerry = "UPDATE users SET Username = '$_POST[Username]', Password = '$_POST[Password]', FirstName = '$_POST[FirstName]', Surname = '$_POST[Surname]' ,DOB = '$_POST[dob]' WHERE UserID = '$_POST[hidden]'";
        mysqli_query($conn, $updateQuerry) or die ("couldn't run query");
//            echo "Record updated";
    }
    ...
    <div>Welcome : <?php
        ...
        {
            echo "<br>";
            echo "<b>You are a junior member</b>";
